...
public class B2 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnLoad = (Button) findViewById(R.id.btnLoadB2);
        img1 = (ImageView) findViewById(R.id.picB2);
        tvMes = (TextView) findViewById(R.id.textViewB2);
    ...
    public void onClick(View view) {
        progressDialog = progressDialog.show(B2.this, "", "Downloading...");
